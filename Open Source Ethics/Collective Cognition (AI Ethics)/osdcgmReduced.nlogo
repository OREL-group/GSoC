...
to take-action
  ;let chosen_action (random 4)
  ;show chosen_action
  ; 0 => qual+ 1 => quan+ 2 => engag+ 3 => all-
  let max_vals (list (max [qual] of other_agents) (max [quan] of other_agents) (max [engag] of other_agents))
  let chosen_action 0
  if (max max_vals) = (item 0 max_vals) [
    set chosen_action 0
  ]
  if (max max_vals) = (item 1 max_vals) [
    set chosen_action 1
  ]
  if (max max_vals) = (item 2 max_vals) [
    set chosen_action 2
  ]
  if (random 50) = 0 [
    set chosen_action 3
